...
export default class TransitionState extends State {
	 ...
	 * Source: Pokemon Game
	 * 
	 * State for when transitioning between game states
	 * 
	 * @param {*} type In or Out
	 * @param {*} onTransitionComplete Callback for when the transition is complete
	 * @param {*} colour Colour for the transition screen
	 */
